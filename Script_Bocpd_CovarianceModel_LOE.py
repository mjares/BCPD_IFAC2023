...
# Params
show = True
basesavefilename = 'Results/CPDResults_LOE_EpCount_100'

# Parameters
truncate = 1000
# Dataset
dFilename = 'CPDDataset_LOE_EpCount_100.ds'
...
# Results
savefilename = f'{basesavefilename}_Bocpd_Covmodel_Trunc{truncate}_LOE_EpCount_100.rs'
